...
export const ProgressCard = () => {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br from-[#2CC5A5] via-teal-500 to-cyan-600 p-5 shadow-lg dark:border-white/10 dark:from-emerald-600 dark:via-teal-700 dark:to-cyan-700">
      <div className="flex items-start justify-between">
        ...
        <span className="rounded-xl bg-white/20 px-2.5 py-1 text-xs font-bold text-white backdrop-blur-sm dark:bg-white/15">Day 24</span>
      </div>
      <p className="mt-2.5 text-xs font-medium leading-relaxed text-white/95">1,540 cal • 104g protein • 8 glasses</p>

      <div className="mt-3.5 h-1.5 overflow-hidden rounded-full bg-white/30 dark:bg-white/25">
