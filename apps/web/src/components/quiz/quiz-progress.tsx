...
export function QuizProgress({ currentIndex, visibleSteps, participantName }: QuizProgressProps) {
  ...
  return (
    <div className="w-full rounded-2xl border border-emerald-100/70 bg-white/70 px-5 py-4 shadow-sm backdrop-blur dark:border-emerald-900/40 dark:bg-neutral-900/70">
